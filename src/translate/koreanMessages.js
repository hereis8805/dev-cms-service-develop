export default {
  ra: {
    ...
    message: {
      about: "소개",
      are_you_sure: "확실합니까?",
      bulk_delete_content: "이 %{name}?을 지우시겠습니까? |||| 이 %{smart_count} 개의 항목들을 지우시겠습니까?",
      bulk_delete_title: "%{name} 삭제 |||| %{smart_count}개의 %{name} 삭제",
    ...
    navigation: {
      ...
      no_more_results: "%{page} 페이지는 범위 밖의 페이지입니다. 이전 페이지를 시도하세요.",
    ...
    notification: {
      ...
      http_error: "서버 통신 오류",
      data_provider_error: "dataProvider 오류. 자세한 내용은 콘솔을 확인하세요.",
