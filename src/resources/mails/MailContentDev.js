...
const MailContentPerson = {
  mailSubject: "[테스트-개인]엠스토리허브_9월 정산 내역입니다.",
  mailBody: `<p><span style="font-family: Arial; font-size: 13px; white-space: pre-wrap; background-color: rgb(255, 255, 255);">[테스트]안녕하세요. 엠스토리허브 정산팀입니다.
...
const MailContentCompany = {
  mailSubject: "[테스트-회사]엠스토리허브_9월 정산 내역입니다.",
  mailBody: `<p><span style="font-family: Arial; font-size: 13px; white-space: pre-wrap; background-color: rgb(255, 255, 255);">[테스트]안녕하세요. 엠스토리허브 정산팀입니다.
